...
DEFAULT_CONTAINERS="demo-participant-wallet-db ngrok-demo-participant demo-participant-agent demo-participant-business-logic
                    yoma-ga-wallet-db ngrok-yoma-ga yoma-ga-agent yoma-ga-business-logic"
                    # tails-server"
...
# Production Settings:
# -----------------------------------------------------------------------------------------------------------------
PRODUCTION_CONTAINERS="demo-participant-wallet-db demo-participant-agent demo-participant-business-logic"
